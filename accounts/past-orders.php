...
if (isset($_SESSION['user'])) {
    try{
        ...
        /* Order Query */
        $order = "SELECT * FROM cart INNER JOIN orders ON cart.order_id=orders.order_id INNER JOIN products ON cart.product_id = products.product_id WHERE orders.username = '" . $_SESSION['screenname'] . "' AND orders.complete = '1' ORDER BY orders.order_id ASC";
...
<head>
    ...
    <title>Simple Panda - View Past Orders</title>
