...
if (isset($_GET['submit'])) {
    if (isset($_SESSION['user'])) {
        try{
            ...
            header("Location: /accounts/wishlist.php");
...
<head>
    ...
    <title>Simple Panda - Wishlist</title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php
                            ...
                            {	
                                ...
                                echo "' title='Delete " . $product['product_name'] . "'>" . $wishlist['product_name'] . "</a></td><td>$" . $wishlist['product_price'] . "</td></tr>";
			                    echo "<tr>";
